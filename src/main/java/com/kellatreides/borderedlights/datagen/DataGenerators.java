...
@EventBusSubscriber(modid = BorderedLights.MODID, bus = EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        generator.addProvider(event.includeServer(), new ModelRecipeProvider(packOutput, lookupProvider));

        BlockTagsProvider blockTagsProvider = new ModBlocksTagProvider(packOutput, lookupProvider, existingFileHelper);
